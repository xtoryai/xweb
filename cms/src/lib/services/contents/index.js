...
/**
 * Pagination state per collection, keyed by collection name.
 * Each entry: { page, totalPages, total, hasMore, loading }
 * @type {Writable<Record<string, { page: number, totalPages: number, total: number, hasMore: boolean, loading: boolean }>>}
 */
